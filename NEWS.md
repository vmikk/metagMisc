...
# metagMisc (development version)

## New functions

* `dist_simpson` - Simpson's dissimilarity index 
...
* fixed `vpd` function  
* build `pkgdown`-based website  


# metagMisc 0.5.0

(git 621e9cf, March 20, 2024)  
...
* `raref_rtk` - [`RTK`](https://github.com/hildebra/Rarefaction)-based rarefaction  
...
# metagMisc 0.0.0.9000

(git 5735960; May 4, 2017)  
